...
import { renderDashboard } from '../modules/dashboard.js?v=cashreal';
...
import { renderVendors }   from '../modules/vendors.js?v=merge2';
import { renderProjects }  from '../modules/projects.js?v=custfix';
import { renderInvoices }  from '../modules/invoices.js?v=paid';
import { renderBills }     from '../modules/bills.js?v=paid';
import { renderPayments }  from '../modules/payments.js?v=sort';
import { renderBank }      from '../modules/bank.js?v=cat3';
import { renderReconcile } from '../modules/reconcile.js';
import { renderReports }   from '../modules/reports.js';
import { renderTen99 }     from '../modules/ten99.js?v=sort';
import { renderSettings }  from '../modules/settings.js?v=gen';
